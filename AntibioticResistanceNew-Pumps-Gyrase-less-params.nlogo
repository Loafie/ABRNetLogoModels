...
breed [sparks spark]
globals[ticks-per-hour counts doses-a doses-b antibiotic-decay die-chance crowding-factor divide-chance absorbtion-rate mutation-rate]
sparks-own[age]
