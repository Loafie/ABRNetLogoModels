...
to setup
  clear-all
  set antibiotic-decay 0.0035
  set die-chance 0.0007
  set crowding-factor 20.0
  set divide-chance 0.01
  set absorbtion-rate 0.07
  set mutation-rate 0.1
  set sample-a-gyrase-mutation? false
  set sample-b-gyrase-mutation? false
  set doses-a 0
  set doses-b 0
  set counts [0 0 0]
...
to move-bacteria
  ask bacteria [
    ...
    if random-float 1 < (divide-chance * (1 - (pumps / 24.0)) * ifelse-value gyrase-resistance? [0.5][1])
...
to do-dosing
  if sample-a-do-dosing? and not (limit-doses-a and (doses-a = num-doses-a))
  [
    if (ticks - (dose-delay-a * ticks-per-hour)) >= 0
    [
      if ((ticks - (dose-delay-a * ticks-per-hour)) mod (dose-frequency-a * ticks-per-hour)) = 0
      [
        if (random 100) > dose-skip-chance-a
        [
          dose 1 dose-size-a
  ...
  if sample-b-do-dosing? and not (limit-doses-b and (doses-b = num-doses-b))
  [
    if (ticks - (dose-delay-b * ticks-per-hour)) >= 0
    [
      if ((ticks - (dose-delay-b * ticks-per-hour)) mod (dose-frequency-b * ticks-per-hour)) = 0
      [
        if (random 100) > dose-skip-chance-b
        [
          dose 2 dose-size-b
...
"" ""
PENS
"pumps" 1.0 1 -16777216 true "" "histogram [pumps] of bacteria with [group = 1]"
...
"" ""
PENS
"pumps" 1.0 1 -16777216 true "" "histogram [pumps] of bacteria with [group = 2]"
...
"" ""
PENS
"1 Pump" 1.0 0 -16777216 true "" "plot count bacteria with [group = 1 and pumps = 1]"
"2 Pumps" 1.0 0 -7500403 true "" "plot count bacteria with [group = 1 and pumps = 2]"
"3 Pumps" 1.0 0 -2674135 true "" "plot count bacteria with [group = 1 and pumps = 3]"
"4 Pumps" 1.0 0 -955883 true "" "plot count bacteria with [group = 1 and pumps = 4]"
"5 Pumps" 1.0 0 -6459832 true "" "plot count bacteria with [group = 1 and pumps = 5]"
"6 Pumps" 1.0 0 -1184463 true "" "plot count bacteria with [group = 1 and pumps = 6]"
"7 Pumps" 1.0 0 -10899396 true "" "plot count bacteria with [group = 1 and pumps = 7]"
"8 Pumps" 1.0 0 -13840069 true "" "plot count bacteria with [group = 1 and pumps = 8]"
"Total Bacteria" 1.0 0 -14835848 true "" "plot count bacteria with [group = 1]"
...
"" ""
PENS
"1 Pump" 1.0 0 -16777216 true "" "plot count bacteria with [group = 2 and pumps = 1]"
"2 Pumps" 1.0 0 -7500403 true "" "plot count bacteria with [group = 2 and pumps = 2]"
"3 Pumps" 1.0 0 -2674135 true "" "plot count bacteria with [group = 2 and pumps = 3]"
"4 Pumps" 1.0 0 -955883 true "" "plot count bacteria with [group = 2 and pumps = 4]"
"5 Pumps" 1.0 0 -6459832 true "" "plot count bacteria with [group = 2 and pumps = 5]"
"6 Pumps" 1.0 0 -1184463 true "" "plot count bacteria with [group = 2 and pumps = 6]"
"7 Pumps" 1.0 0 -10899396 true "" "plot count bacteria with [group = 2 and pumps = 7]"
"8 Pumps" 1.0 0 -13840069 true "" "plot count bacteria with [group = 2 and pumps = 8]"
"Total Bacteria" 1.0 0 -14835848 true "" "plot count bacteria with [group = 2]"
